$(document).ready(function(){
    ...
    <input id="ingredients" name="ingredients" type="text" maxlength="100" class="validate" pattern="^\S+[a-zA-Z0-9]+,.?_\s]+$" required>
    ...
    <input id='instructions' name='instructions' type='text' maxlength='100' class='validate' pattern="^\S+[a-zA-Z0-9]+,.?_\s]+$" required>
